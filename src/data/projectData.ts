export type Status = 'Ej påbörjad' | 'Pågår' | 'Slutförd' | 'Försenad' | 'Förväntad' | 'Risk för försening';
...
export const statuses: Status[] = ['Ej påbörjad', 'Pågår', 'Risk för försening', 'Slutförd', 'Försenad', 'Förväntad'];
